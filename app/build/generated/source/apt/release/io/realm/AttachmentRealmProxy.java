...
public class AttachmentRealmProxy extends com.nazpowerchat.models.Attachment
    ...
    private ProxyState<com.nazpowerchat.models.Attachment> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.nazpowerchat.models.Attachment>(this);
    ...
    @SuppressWarnings("cast")
    public static com.nazpowerchat.models.Attachment createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.nazpowerchat.models.Attachment obj = realm.createObjectInternal(com.nazpowerchat.models.Attachment.class, true, excludeFields);
        if (json.has("name")) {
            if (json.isNull("name")) {
    ...
    public static com.nazpowerchat.models.Attachment createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.nazpowerchat.models.Attachment obj = new com.nazpowerchat.models.Attachment();
        reader.beginObject();
    ...
    public static com.nazpowerchat.models.Attachment copyOrUpdate(Realm realm, com.nazpowerchat.models.Attachment object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Attachment) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.nazpowerchat.models.Attachment copy(Realm realm, com.nazpowerchat.models.Attachment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Attachment) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.nazpowerchat.models.Attachment realmObject = realm.createObjectInternal(com.nazpowerchat.models.Attachment.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.nazpowerchat.models.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Attachment.class);
        long tableNativePtr = table.getNativeTablePointer();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Attachment.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Attachment.class);
        com.nazpowerchat.models.Attachment object = null;
        while (objects.hasNext()) {
            object = (com.nazpowerchat.models.Attachment) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.nazpowerchat.models.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Attachment.class);
    ...
    public static com.nazpowerchat.models.Attachment createDetachedCopy(com.nazpowerchat.models.Attachment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.nazpowerchat.models.Attachment unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.nazpowerchat.models.Attachment)cachedObject.object;
            } else {
                unmanagedObject = (com.nazpowerchat.models.Attachment)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.nazpowerchat.models.Attachment();
