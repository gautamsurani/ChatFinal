...
public class UserRealmProxy extends com.nazpowerchat.models.User
    ...
    private ProxyState<com.nazpowerchat.models.User> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.nazpowerchat.models.User>(this);
    ...
    @SuppressWarnings("cast")
    public static com.nazpowerchat.models.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.nazpowerchat.models.User obj = realm.createObjectInternal(com.nazpowerchat.models.User.class, true, excludeFields);
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static com.nazpowerchat.models.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.nazpowerchat.models.User obj = new com.nazpowerchat.models.User();
        reader.beginObject();
    ...
    public static com.nazpowerchat.models.User copyOrUpdate(Realm realm, com.nazpowerchat.models.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.User) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.nazpowerchat.models.User copy(Realm realm, com.nazpowerchat.models.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.User) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.nazpowerchat.models.User realmObject = realm.createObjectInternal(com.nazpowerchat.models.User.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.nazpowerchat.models.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.User.class);
        long tableNativePtr = table.getNativeTablePointer();
        UserColumnInfo columnInfo = (UserColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.User.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        UserColumnInfo columnInfo = (UserColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.User.class);
        com.nazpowerchat.models.User object = null;
        while (objects.hasNext()) {
            object = (com.nazpowerchat.models.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.nazpowerchat.models.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.User.class);
    ...
    public static com.nazpowerchat.models.User createDetachedCopy(com.nazpowerchat.models.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.nazpowerchat.models.User unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.nazpowerchat.models.User)cachedObject.object;
            } else {
                unmanagedObject = (com.nazpowerchat.models.User)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.nazpowerchat.models.User();
