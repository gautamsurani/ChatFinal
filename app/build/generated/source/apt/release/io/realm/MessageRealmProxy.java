...
public class MessageRealmProxy extends com.nazpowerchat.models.Message
    ...
    private ProxyState<com.nazpowerchat.models.Message> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.nazpowerchat.models.Message>(this);
    ...
    @Override
    public com.nazpowerchat.models.Attachment realmGet$attachment() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.attachmentIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.nazpowerchat.models.Attachment.class, proxyState.getRow$realm().getLink(columnInfo.attachmentIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$attachment(com.nazpowerchat.models.Attachment value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static com.nazpowerchat.models.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("attachment")) {
            excludeFields.add("attachment");
        }
        com.nazpowerchat.models.Message obj = realm.createObjectInternal(com.nazpowerchat.models.Message.class, true, excludeFields);
        if (json.has("body")) {
            if (json.isNull("body")) {
        ...
        if (json.has("attachment")) {
            if (json.isNull("attachment")) {
                ...
                com.nazpowerchat.models.Attachment attachmentObj = AttachmentRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("attachment"), update);
    ...
    public static com.nazpowerchat.models.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.nazpowerchat.models.Message obj = new com.nazpowerchat.models.Message();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.nazpowerchat.models.Attachment attachmentObj = AttachmentRealmProxy.createUsingJsonStream(realm, reader);
                    ((MessageRealmProxyInterface) obj).realmSet$attachment(attachmentObj);
                }
            } else {
                reader.skipValue();
    ...
    public static com.nazpowerchat.models.Message copyOrUpdate(Realm realm, com.nazpowerchat.models.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Message) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.nazpowerchat.models.Message copy(Realm realm, com.nazpowerchat.models.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Message) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.nazpowerchat.models.Message realmObject = realm.createObjectInternal(com.nazpowerchat.models.Message.class, false, Collections.<String>emptyList());
            ...
            com.nazpowerchat.models.Attachment attachmentObj = ((MessageRealmProxyInterface) newObject).realmGet$attachment();
            if (attachmentObj != null) {
                com.nazpowerchat.models.Attachment cacheattachment = (com.nazpowerchat.models.Attachment) cache.get(attachmentObj);
    ...
    public static long insert(Realm realm, com.nazpowerchat.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Message.class);
        long tableNativePtr = table.getNativeTablePointer();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Message.class);
        ...
        com.nazpowerchat.models.Attachment attachmentObj = ((MessageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Message.class);
        com.nazpowerchat.models.Message object = null;
        while (objects.hasNext()) {
            object = (com.nazpowerchat.models.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.nazpowerchat.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Message.class);
    ...
    public static com.nazpowerchat.models.Message createDetachedCopy(com.nazpowerchat.models.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.nazpowerchat.models.Message unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.nazpowerchat.models.Message)cachedObject.object;
            } else {
                unmanagedObject = (com.nazpowerchat.models.Message)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.nazpowerchat.models.Message();
