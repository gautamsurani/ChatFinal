...
public class MyStringRealmProxy extends com.nazpowerchat.models.MyString
    ...
    private ProxyState<com.nazpowerchat.models.MyString> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.nazpowerchat.models.MyString>(this);
    ...
    @SuppressWarnings("cast")
    public static com.nazpowerchat.models.MyString createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.nazpowerchat.models.MyString obj = realm.createObjectInternal(com.nazpowerchat.models.MyString.class, true, excludeFields);
        if (json.has("string")) {
    ...
    public static com.nazpowerchat.models.MyString createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.nazpowerchat.models.MyString obj = new com.nazpowerchat.models.MyString();
        reader.beginObject();
    ...
    public static com.nazpowerchat.models.MyString copyOrUpdate(Realm realm, com.nazpowerchat.models.MyString object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.MyString) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.nazpowerchat.models.MyString copy(Realm realm, com.nazpowerchat.models.MyString newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.MyString) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.nazpowerchat.models.MyString realmObject = realm.createObjectInternal(com.nazpowerchat.models.MyString.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.nazpowerchat.models.MyString object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.MyString.class);
        long tableNativePtr = table.getNativeTablePointer();
        MyStringColumnInfo columnInfo = (MyStringColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.MyString.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        MyStringColumnInfo columnInfo = (MyStringColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.MyString.class);
        com.nazpowerchat.models.MyString object = null;
        while (objects.hasNext()) {
            object = (com.nazpowerchat.models.MyString) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.nazpowerchat.models.MyString object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.MyString.class);
    ...
    public static com.nazpowerchat.models.MyString createDetachedCopy(com.nazpowerchat.models.MyString realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.nazpowerchat.models.MyString unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.nazpowerchat.models.MyString)cachedObject.object;
            } else {
                unmanagedObject = (com.nazpowerchat.models.MyString)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.nazpowerchat.models.MyString();
