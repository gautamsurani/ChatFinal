...
public class GroupRealmProxy extends com.nazpowerchat.models.Group
    ...
    private ProxyState<com.nazpowerchat.models.Group> proxyState;
    private RealmList<com.nazpowerchat.models.MyString> userIdsRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.nazpowerchat.models.Group>(this);
    ...
    public RealmList<com.nazpowerchat.models.MyString> realmGet$userIds() {
        ...
        if (userIdsRealmList != null) {
            ...
            userIdsRealmList = new RealmList<com.nazpowerchat.models.MyString>(com.nazpowerchat.models.MyString.class, linkView, proxyState.getRealm$realm());
            return userIdsRealmList;
        }
    }
    ...
    public void realmSet$userIds(RealmList<com.nazpowerchat.models.MyString> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.nazpowerchat.models.MyString> original = value;
                value = new RealmList<com.nazpowerchat.models.MyString>();
                for (com.nazpowerchat.models.MyString item : original) {
    ...
    @SuppressWarnings("cast")
    public static com.nazpowerchat.models.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("userIds")) {
            excludeFields.add("userIds");
        }
        com.nazpowerchat.models.Group obj = realm.createObjectInternal(com.nazpowerchat.models.Group.class, true, excludeFields);
        if (json.has("id")) {
            if (json.isNull("id")) {
        ...
        if (json.has("userIds")) {
            if (json.isNull("userIds")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.nazpowerchat.models.MyString item = MyStringRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.nazpowerchat.models.Group createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.nazpowerchat.models.Group obj = new com.nazpowerchat.models.Group();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    ((GroupRealmProxyInterface) obj).realmSet$userIds(new RealmList<com.nazpowerchat.models.MyString>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.nazpowerchat.models.MyString item = MyStringRealmProxy.createUsingJsonStream(realm, reader);
                        ((GroupRealmProxyInterface) obj).realmGet$userIds().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.nazpowerchat.models.Group copyOrUpdate(Realm realm, com.nazpowerchat.models.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Group) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.nazpowerchat.models.Group copy(Realm realm, com.nazpowerchat.models.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Group) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.nazpowerchat.models.Group realmObject = realm.createObjectInternal(com.nazpowerchat.models.Group.class, false, Collections.<String>emptyList());
            ...
            RealmList<com.nazpowerchat.models.MyString> userIdsList = ((GroupRealmProxyInterface) newObject).realmGet$userIds();
            if (userIdsList != null) {
                RealmList<com.nazpowerchat.models.MyString> userIdsRealmList = ((GroupRealmProxyInterface) realmObject).realmGet$userIds();
                for (int i = 0; i < userIdsList.size(); i++) {
                    com.nazpowerchat.models.MyString userIdsItem = userIdsList.get(i);
                    com.nazpowerchat.models.MyString cacheuserIds = (com.nazpowerchat.models.MyString) cache.get(userIdsItem);
    ...
    public static long insert(Realm realm, com.nazpowerchat.models.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Group.class);
        long tableNativePtr = table.getNativeTablePointer();
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Group.class);
        ...
        RealmList<com.nazpowerchat.models.MyString> userIdsList = ((GroupRealmProxyInterface) object).realmGet$userIds();
        if (userIdsList != null) {
            long userIdsNativeLinkViewPtr = Table.nativeGetLinkView(tableNativePtr, columnInfo.userIdsIndex, rowIndex);
            for (com.nazpowerchat.models.MyString userIdsItem : userIdsList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Group.class);
        com.nazpowerchat.models.Group object = null;
        while (objects.hasNext()) {
            object = (com.nazpowerchat.models.Group) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.nazpowerchat.models.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Group.class);
    ...
    public static com.nazpowerchat.models.Group createDetachedCopy(com.nazpowerchat.models.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.nazpowerchat.models.Group unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.nazpowerchat.models.Group)cachedObject.object;
            } else {
                unmanagedObject = (com.nazpowerchat.models.Group)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.nazpowerchat.models.Group();
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.nazpowerchat.models.MyString> manageduserIdsList = ((GroupRealmProxyInterface) realmObject).realmGet$userIds();
            RealmList<com.nazpowerchat.models.MyString> unmanageduserIdsList = new RealmList<com.nazpowerchat.models.MyString>();
            ((GroupRealmProxyInterface) unmanagedObject).realmSet$userIds(unmanageduserIdsList);
            int nextDepth = currentDepth + 1;
            int size = manageduserIdsList.size();
            for (int i = 0; i < size; i++) {
                com.nazpowerchat.models.MyString item = MyStringRealmProxy.createDetachedCopy(manageduserIdsList.get(i), nextDepth, maxDepth, cache);
