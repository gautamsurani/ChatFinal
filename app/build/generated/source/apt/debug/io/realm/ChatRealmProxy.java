...
public class ChatRealmProxy extends com.nazpowerchat.models.Chat
    ...
    private ProxyState<com.nazpowerchat.models.Chat> proxyState;
    private RealmList<com.nazpowerchat.models.Message> messagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.nazpowerchat.models.Chat>(this);
    ...
    public RealmList<com.nazpowerchat.models.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.nazpowerchat.models.Message>(com.nazpowerchat.models.Message.class, linkView, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<com.nazpowerchat.models.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.nazpowerchat.models.Message> original = value;
                value = new RealmList<com.nazpowerchat.models.Message>();
                for (com.nazpowerchat.models.Message item : original) {
    ...
    public com.nazpowerchat.models.User realmGet$user() {
        ...
        return proxyState.getRealm$realm().get(com.nazpowerchat.models.User.class, proxyState.getRow$realm().getLink(columnInfo.userIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.nazpowerchat.models.Group realmGet$group() {
        ...
        return proxyState.getRealm$realm().get(com.nazpowerchat.models.Group.class, proxyState.getRow$realm().getLink(columnInfo.groupIndex), false, Collections.<String>emptyList());
    }
    ...
    @SuppressWarnings("cast")
    public static com.nazpowerchat.models.Chat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.nazpowerchat.models.Chat obj = realm.createObjectInternal(com.nazpowerchat.models.Chat.class, true, excludeFields);
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.nazpowerchat.models.Message item = MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        if (json.has("user")) {
            if (json.isNull("user")) {
                ...
                com.nazpowerchat.models.User userObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("user"), update);
        ...
        if (json.has("group")) {
            if (json.isNull("group")) {
                ...
                com.nazpowerchat.models.Group groupObj = GroupRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("group"), update);
    ...
    public static com.nazpowerchat.models.Chat createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.nazpowerchat.models.Chat obj = new com.nazpowerchat.models.Chat();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    ((ChatRealmProxyInterface) obj).realmSet$messages(new RealmList<com.nazpowerchat.models.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.nazpowerchat.models.Message item = MessageRealmProxy.createUsingJsonStream(realm, reader);
                        ((ChatRealmProxyInterface) obj).realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.nazpowerchat.models.User userObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    ((ChatRealmProxyInterface) obj).realmSet$user(userObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.nazpowerchat.models.Group groupObj = GroupRealmProxy.createUsingJsonStream(realm, reader);
                    ((ChatRealmProxyInterface) obj).realmSet$group(groupObj);
                }
    ...
    public static com.nazpowerchat.models.Chat copyOrUpdate(Realm realm, com.nazpowerchat.models.Chat object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Chat) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.nazpowerchat.models.Chat copy(Realm realm, com.nazpowerchat.models.Chat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.nazpowerchat.models.Chat) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.nazpowerchat.models.Chat realmObject = realm.createObjectInternal(com.nazpowerchat.models.Chat.class, false, Collections.<String>emptyList());
            cache.put(newObject, (RealmObjectProxy) realmObject);

            RealmList<com.nazpowerchat.models.Message> messagesList = ((ChatRealmProxyInterface) newObject).realmGet$messages();
            if (messagesList != null) {
                RealmList<com.nazpowerchat.models.Message> messagesRealmList = ((ChatRealmProxyInterface) realmObject).realmGet$messages();
                for (int i = 0; i < messagesList.size(); i++) {
                    com.nazpowerchat.models.Message messagesItem = messagesList.get(i);
                    com.nazpowerchat.models.Message cachemessages = (com.nazpowerchat.models.Message) cache.get(messagesItem);
            ...
            com.nazpowerchat.models.User userObj = ((ChatRealmProxyInterface) newObject).realmGet$user();
            if (userObj != null) {
                com.nazpowerchat.models.User cacheuser = (com.nazpowerchat.models.User) cache.get(userObj);
                if (cacheuser != null) {
            ...
            com.nazpowerchat.models.Group groupObj = ((ChatRealmProxyInterface) newObject).realmGet$group();
            if (groupObj != null) {
                com.nazpowerchat.models.Group cachegroup = (com.nazpowerchat.models.Group) cache.get(groupObj);
                if (cachegroup != null) {
    ...
    public static long insert(Realm realm, com.nazpowerchat.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Chat.class);
        long tableNativePtr = table.getNativeTablePointer();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Chat.class);
        long rowIndex = Table.nativeAddEmptyRow(tableNativePtr, 1);
        cache.put(object, rowIndex);

        RealmList<com.nazpowerchat.models.Message> messagesList = ((ChatRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            long messagesNativeLinkViewPtr = Table.nativeGetLinkView(tableNativePtr, columnInfo.messagesIndex, rowIndex);
            for (com.nazpowerchat.models.Message messagesItem : messagesList) {
        ...
        com.nazpowerchat.models.User userObj = ((ChatRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        com.nazpowerchat.models.Group groupObj = ((ChatRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.schema.getColumnInfo(com.nazpowerchat.models.Chat.class);
        com.nazpowerchat.models.Chat object = null;
        while (objects.hasNext()) {
            object = (com.nazpowerchat.models.Chat) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.nazpowerchat.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.nazpowerchat.models.Chat.class);
    ...
    public static com.nazpowerchat.models.Chat createDetachedCopy(com.nazpowerchat.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.nazpowerchat.models.Chat unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.nazpowerchat.models.Chat)cachedObject.object;
            } else {
                unmanagedObject = (com.nazpowerchat.models.Chat)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.nazpowerchat.models.Chat();
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.nazpowerchat.models.Message> managedmessagesList = ((ChatRealmProxyInterface) realmObject).realmGet$messages();
            RealmList<com.nazpowerchat.models.Message> unmanagedmessagesList = new RealmList<com.nazpowerchat.models.Message>();
            ...
            for (int i = 0; i < size; i++) {
                com.nazpowerchat.models.Message item = MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
